...
namespace Runtime.TowerRelated
{
    public class TowerMaker : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            EventManager.Instance.UpgradeTowerEvent += OnUpgradeTower;
        }
        ...
        private void OnCreateTower(int tierToCreate)
        {
            if (tierToCreate < 0)
            {
                var tier = tierToCreate - MapConfig.TutorialMapOffset;
                CreateTower(tutorialTowers[tier], tutorialTowers[tier].towerRarity);
            }
            else
            {
                tier = tierToCreate;
        ...
        [Button]
        public void CreateTower(Tower tower, ItemRarity rarity = ItemRarity.Normal)
        {
            ...
            modifierCount = rarityNumber * 2;
            tower.towerRarity = rarity;
        ...
        public void InitialiseTowerModifiers()
        {
            ...
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterHealthIncrease, 10, 30).SetText(TempModifierTexts
                    .MonsterHealthIncrease));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterSpeedIncrease, 10, 30).SetText(TempModifierTexts
                    .MonsterSpeedIncrease));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterDamageIncrease, 10, 30).SetText(TempModifierTexts
                    .MonsterDamageIncrease));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterRangeIncrease, 10, 30).SetText(TempModifierTexts
                    .MonsterRangeIncrease));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterDefenceIncrease, 10, 30).SetText(TempModifierTexts
                    .MonsterDefenceIncrease));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterEvasionIncrease, 10, 30).SetText(TempModifierTexts
                    .MonsterEvasionIncrease));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterAttackSpeedIncrease, 10, 30).SetText(TempModifierTexts
                    .MonsterAttackSpeedIncrease));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterAlwaysDealCriticalHit, 10, 30).SetText(TempModifierTexts
                    .MonsterAlwaysDealCriticalHit));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterDontTakeCriticalHit, 10, 30).SetText(TempModifierTexts
                    .MonsterDontTakeCriticalHit));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterCriticalDamageIncrease, 10, 30).SetText(TempModifierTexts
                    .MonsterCriticalDamageIncrease));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterHitsShock, 10, 30).SetText(TempModifierTexts
                    .MonsterHitsShock));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterHitsFreeze, 10, 30).SetText(TempModifierTexts
                    .MonsterHitsFreeze));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterHitsBurn, 10, 30).SetText(TempModifierTexts
                    .MonsterHitsBurn));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterCantBeFrozen, 10, 30).SetText(TempModifierTexts
                    .MonsterCantBeFrozen));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterCantBeBurn, 10, 30).SetText(TempModifierTexts
                    .MonsterCantBeBurn));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterCantBeShocked, 10, 30).SetText(TempModifierTexts
                    .MonsterCantBeShocked));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterHealthRegen, 10, 30).SetText(TempModifierTexts
                    .MonsterHealthRegen));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterCantTakeMagicalDamage, 10, 30).SetText(TempModifierTexts
                    .MonsterCantTakeMagicalDamage));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterCantTakeMeleeDamage, 10, 30).SetText(TempModifierTexts
                    .MonsterCantTakeMeleeDamage));
            TowerModifiers.Add(
                new TowerModifier(TowerMonsterModifiers.MonsterCantTakeRangedDamage, 10, 30).SetText(TempModifierTexts
