...
{
    public abstract class AbstractMVCMediationBinder : strange.framework.impl.Binder, IMVCMediationBinder
    {
        [Inject]
        ...
        public void Trigger(MediationEvent evt, IView view)
        {
            ...
            {
                Debug.LogError("Hello there, you are trying to bind " + view + " without a mediation. This is not allowed.");
            }
        }
        ...
        public void ActivateRoot(GameObject root)
        {
            ...
            injectionBinder.injector.Inject(root.GetComponent<IMVCRoot>(), false);
        }
