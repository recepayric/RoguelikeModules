...
namespace strange.extensions.command.api
{
	public interface ICommandBinder : IBinder
	{
		...
		ICommandBinding CreateCustomBinding();
		void DispatchCustomCommand(ICommandBinding commandBinding, params object[] data);
		void DispatchCustomCommand<TCommand, TSignalType1, TSignalType2>(params object[] data);
		void DispatchCustomCommand<TCommand, TSignalType>(params object[] data);
		void DispatchCustomCommand<TCommand>(params object[] data);
	}
}
