...
using MVC.Base.Runtime.Concrete.Injectable.Provider;
...
{
    public class MVCContext : CrossContext
    {
        /// A Binder that maps Views to Mediators
        public IMVCMediationBinder mediationBinder { get; set; }
        ...
        public MVCContext(GameObject root)
        {
        ...
        protected override void addCoreComponents()
        {
            ...
            injectionBinder.Bind<IMVCMediationBinder>().To<MVCMediationBinder>().ToSingleton();
            ...
            injectionBinder.Bind<IImplicitBinder>().To<MVCImplicitBinder>().ToSingleton();
        ...
        protected override void instantiateCoreComponents()
        {
            ...
            mediationBinder = injectionBinder.GetInstance<IMVCMediationBinder>() as IMVCMediationBinder;
        ...
        public void UnbindAllBinder()
        {
            CrossContextInjectionBinder injectionBinder = this.injectionBinder as CrossContextInjectionBinder;
            injectionBinder.UnbindAll();
            CommandBinder commandBinder = this.commandBinder as CommandBinder;
            commandBinder.UnbindAll();
            //MvcMediationBinder mediationBinder = this.mediationBinder as MvcMediationBinder;
