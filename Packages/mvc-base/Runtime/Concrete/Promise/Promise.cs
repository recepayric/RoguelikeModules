...
using System.Linq;
using MVC.Base.Runtime.Concrete.Promise.Exceptions;

namespace MVC.Base.Runtime.Concrete.Promise
{
    /// <summary>
    /// Implements a C# promise.
    /// https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/Promise
    /// </summary>
    public abstract class IPromise<PromisedT>
    {
        /// <summary>
        ...
        /// </summary>
        public abstract IPromise<PromisedT> WithName(string name);
        ...
        /// </summary>
        public abstract void Done(Action<PromisedT> onResolved, Action<Exception> onRejected);
        ...
        /// </summary>
        public abstract void Done(Action<PromisedT> onResolved);
        ...
        /// </summary>
        public abstract IPromise Catch(Action<Exception> onRejected);

        /// <summary>
        /// Handle errors for the promise. 
        /// </summary>
        public abstract IPromise<PromisedT> Catch(Func<Exception, PromisedT> onRejected);

        /// <summary>
        /// Add a resolved callback that chains a value promise (optionally converting to a different value type).
        /// </summary>
        public abstract IPromise<ConvertedT> Then<ConvertedT>(Func<PromisedT, IPromise<ConvertedT>> onResolved);

        /// <summary>
        /// Add a resolved callback that chains a non-value promise.
        /// </summary>
        public abstract IPromise Then(Func<PromisedT, IPromise> onResolved);

        /// <summary>
        /// Add a resolved callback.
        /// </summary>
        public abstract IPromise Then(Action<PromisedT> onResolved);
        ...
        /// </summary>
        public abstract IPromise Then(Func<PromisedT, IPromise> onResolved, Action<Exception> onRejected);

        /// <summary>
        /// Add a resolved callback and a rejected callback.
        /// </summary>
        public abstract IPromise Then(Action<PromisedT> onResolved, Action<Exception> onRejected);
        ...
        /// The resolved callback chains a non-value promise.
        /// </summary>
        public abstract IPromise Then(Func<PromisedT, IPromise> onResolved, Action<Exception> onRejected, Action<float> onProgress);

        /// <summary>
        /// Add a resolved callback, a rejected callback and a progress callback.
        /// </summary>
        public abstract IPromise Then(Action<PromisedT> onResolved, Action<Exception> onRejected, Action<float> onProgress);

        /// <summary>
        /// Return a new promise with a different value.
        /// May also change the type of the value.
        /// </summary>
        public abstract IPromise<ConvertedT> Then<ConvertedT>(Func<PromisedT, ConvertedT> transform);
        ...
        /// </summary>
        public abstract IPromise<IEnumerable<ConvertedT>> ThenAll<ConvertedT>(Func<PromisedT, IEnumerable<IPromise<ConvertedT>>> chain);
        ...
        /// It is rejected as soon as any of the promises have been rejected.
        /// </summary>
        public abstract IPromise ThenAll(Func<PromisedT, IEnumerable<IPromise>> chain);
        ...
        /// </summary>
        public abstract IPromise<ConvertedT> ThenRace<ConvertedT>(Func<PromisedT, IEnumerable<IPromise<ConvertedT>>> chain);
        ...
        /// Yields the value from the first promise that has resolved.
        /// </summary>
        public abstract IPromise ThenRace(Func<PromisedT, IEnumerable<IPromise>> chain);
        ...
        /// </summary> 
        public abstract IPromise<PromisedT> Finally(Action onComplete);
        ...
        /// </summary>
        public abstract IPromise ContinueWith(Func<IPromise> onResolved);
        ...
        /// </summary> 
        public abstract IPromise<ConvertedT> ContinueWith<ConvertedT>(Func<IPromise<ConvertedT>> onComplete);
        ...
        /// of the promise.
        /// </summary>
        public abstract IPromise<PromisedT> Progress(Action<float> onProgress);
    }
...
//            Argument.NotNull(() => ex);
        ...
        /// Add a resolved callback that chains a value promise (optionally converting to a different value type).
        /// </summary>
        public override IPromise<ConvertedT> Then<ConvertedT>(Func<PromisedT, IPromise<ConvertedT>> onResolved)
        {
        ...
        /// The resolved callback chains a value promise (optionally converting to a different value type).
        /// </summary>
        public override IPromise<ConvertedT> Then<ConvertedT>(
...
//            Argument.NotNull(() => onResolved); 
        ...
        /// The resolved callback chains a non-value promise.
        /// </summary>
        public override IPromise Then(Func<PromisedT, IPromise> onResolved, Action<Exception> onRejected, Action<float> onProgress)
        {
            var resultPromise = new Promise();
            resultPromise.WithName(Name);
        ...
        /// Add a resolved callback, a rejected callback and a progress callback.
        /// </summary>
        public override IPromise Then(Action<PromisedT> onResolved, Action<Exception> onRejected, Action<float> onProgress)
        {
            var resultPromise = new Promise();
            resultPromise.WithName(Name);
        ...
        /// May also change the type of the value.
        /// </summary>
        public override IPromise<ConvertedT> Then<ConvertedT>(Func<PromisedT, ConvertedT> transform)
        {
//            Argument.NotNull(() => transform);
        ...
        /// It is rejected as soon as any of the promises have been rejected.
        /// </summary>
        public override IPromise<IEnumerable<ConvertedT>> ThenAll<ConvertedT>(Func<PromisedT, IEnumerable<IPromise<ConvertedT>>> chain)
        {
        ...
        /// It is rejected as soon as any of the promises have been rejected.
        /// </summary>
        public override IPromise ThenAll(Func<PromisedT, IEnumerable<IPromise>> chain)
        {
        ...
        /// Yields the value from the first promise that has resolved.
        /// </summary>
        public override IPromise<ConvertedT> ThenRace<ConvertedT>(Func<PromisedT, IEnumerable<IPromise<ConvertedT>>> chain)
        {
        ...
        /// Yields the value from the first promise that has resolved.
        /// </summary>
        public override IPromise ThenRace(Func<PromisedT, IEnumerable<IPromise>> chain)
        {
...
//            Argument.NotNull(() => ex);
        ...
        public override IPromise<ConvertedT> ContinueWith<ConvertedT>(Func<IPromise<ConvertedT>> onComplete)
        {
            var promise = new Promise();
            promise.WithName(Name);
        ...
        public override IPromise<PromisedT> Progress(Action<float> onProgress)
        {
            if (onProgress != null)
            {
                ProgressHandlers(this, onProgress);
