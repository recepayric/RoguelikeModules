...
namespace MVC.Base.Editor.Concrete.ModelViewer
{
    ...
    {
        private MVCContextRoot _inspectedRoot;
        ...
        private void DrawModels()
        {
            ...
            {
                EditorGUILayout.LabelField("Select a MVCContext Root GameObject");
                return;
            }
            ...
            _inspectedRoot = rootGameObject.GetComponent<MVCContextRoot>();
            ...
            SirenixEditorFields.UnityObjectField("Inspecting", _inspectedRoot, typeof(MVCContextRoot),true);
