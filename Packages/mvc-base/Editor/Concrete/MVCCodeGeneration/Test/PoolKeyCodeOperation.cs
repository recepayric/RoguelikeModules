...
{
    [CreateAssetMenu(fileName = "PoolKeyCodeOperation", menuName = "MVC/Admin/Code Generation Operations/PoolKeyCodeOperation")]
    public class PoolKeyCodeOperation : CodeGenerationOperation
    <PoolKeyCodeOperation,
        PoolKeyCodeOperation.StartArgs,
        PoolKeyCodeOperation.OperateArgs>
    {
        ...
        {
            string poolKeyPath = _sharedSettings.ProjectEnumsPath + "/" + "PoolKey.cs";
        ...
        private string LoadTemplate()
        {
            try
            {
                ...
                string path = _sharedSettings.TestTemplatePath + "/TemplatePoolKey" + ".txt";
