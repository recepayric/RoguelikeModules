...
namespace MVC.Base.Editor.Concrete.MVCCodeGeneration.Test.CodeGenerationOperations
{
    ...
    //[CreateAssetMenu(fileName = "TSelf", menuName = "MVC/Admin/Code Generation Operations/'TSelf'")]
    public abstract class CodeGenerationOperation<TSelf,TStartArgs,TOperateArgs> : CodeGenerationOperation where TSelf : CodeGenerationOperation<TSelf,TStartArgs,TOperateArgs>
    {
